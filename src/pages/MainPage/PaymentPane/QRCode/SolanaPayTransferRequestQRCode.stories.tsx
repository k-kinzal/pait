...
export default {
  title: "Components/SolanaPayTransferRequestQRCode",
  component: SolanaPayTransferRequestQRCode,
};
...
export const Designed: Story = {
  args: {
    ...
    dotsOptions: {
      ...
      gradient: {
        type: "linear",
        rotation: 5.427973973702365,
        colorStops: [
          { offset: 0, color: "#9a45ff" },
          { offset: 1, color: "#17fb9b" },
        ],
      },
    },
